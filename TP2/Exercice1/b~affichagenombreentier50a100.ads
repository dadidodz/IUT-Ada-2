...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_affichagenombreentier50a100" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#777c3322#;
   pragma Export (C, u00001, "affichagenombreentier50a100B");
